...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn("ml-auto text-xs font-semibold text-muted-foreground", className)}
      {...props}
    />
  );
}
