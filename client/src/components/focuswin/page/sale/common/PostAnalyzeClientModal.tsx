...
import ChoiceDialog from "@/components/focuswin/common/overlays/choice-dialog";

/**
 * AI 분석 완료 후 거래처 연결 확인 다이얼로그
 *
 * 두 가지 모드:
 * A. 유사 거래처 있음 (matched_name 존재)
 *    "혹시 등록된 '○○'를 말씀하시는 건가요?"
 *    → 확인: 매칭 거래처에 연결  / 거부: AI 추출 이름으로 신규 등록 후 연결
 *
 * B. 유사 거래처 없음 (matched_name null)
 *    "AI가 '○○'를 거래처로 인식했습니다. 신규 등록하시겠습니까?"
      ...
      <ChoiceDialog
        ...
        body={
          <div className="rounded-2xl border border-slate-100 bg-slate-50 px-4 py-3 text-xs space-y-2">
            ...
            <div className="flex items-start gap-2">
              <span className="text-slate-400 w-24 shrink-0">등록된 거래처</span>
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <p className="text-base font-black text-slate-900 leading-snug">
              ...
              을(를) 거래처로 인식했습니다.
              <br />
              <span className="font-medium text-slate-600 text-sm">신규 거래처로 등록하시겠습니까?</span>
            </p>
          </div>
        </div>
      }
