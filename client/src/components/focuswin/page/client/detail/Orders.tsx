...
export default function ClientDetailOrders({
  orders,
  loading,
}: {
  orders?: OrderRow[];
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        ...
        <Link href="/orde-list" className="text-sm font-bold text-blue-600 hover:text-blue-700">
          수주 관리
        </Link>
      </div>
              ...
              <div className="min-w-0 flex-1">
                ...
                <WorkItemCard.Body>
                  <p className="text-sm font-black text-slate-900">
                    {formatKRW(Number(order.orde_pric))}
                  </p>
                </WorkItemCard.Body>
              </div>
            </WorkItemCard>
