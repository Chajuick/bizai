        ...
        <div className="flex-1">
          ...
          <div className="mt-3 space-y-2 text-sm">
            {client.contactPerson && (
              <Row icon={Users} label="담당" value={client.contactPerson} />
            )}
            {client.contactPhone && (
              <Row icon={Phone} label="연락처" value={client.contactPhone} />
            )}
            {client.contactEmail && (
              <Row icon={Mail} label="이메일" value={client.contactEmail} />
            )}
            {client.address && (
              <Row icon={MapPin} label="주소" value={client.address} />
            )}
          </div>
