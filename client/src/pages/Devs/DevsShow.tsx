...
import Avatar from "@/components/focuswin/common/ui/avatar";
import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbPage, BreadcrumbSeparator } from "@/components/ui/breadcrumb";
import { Button } from "@/components/focuswin/common/ui/button";
import { Calendar } from "@/components/focuswin/common/ui/calendar";
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/components/focuswin/common/ui/card";
import { Carousel, CarouselContent, CarouselItem, CarouselNext, CarouselPrevious } from "@/components/ui/carousel";
import { Checkbox } from "@/components/focuswin/common/ui/checkbox";
import { Collapsible, CollapsibleContent, CollapsibleTrigger } from "@/components/ui/collapsible";
import { Command, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList } from "@/components/focuswin/common/ui/command";
...
import { InputOTP, InputOTPGroup, InputOTPSlot } from "@/components/focuswin/common/ui/input-otp";
import { Label } from "@/components/ui/label";
import { Menubar, MenubarContent, MenubarItem, MenubarMenu, MenubarSeparator, MenubarTrigger } from "@/components/ui/menubar";
import { Pagination, PaginationContent, PaginationItem, PaginationLink, PaginationNext, PaginationPrevious } from "@/components/ui/pagination";
import { Popover, PopoverContent, PopoverTrigger } from "@/components/focuswin/common/ui/popover";
import { Progress } from "@/components/ui/progress";
import { RadioGroup, RadioGroupItem } from "@/components/focuswin/common/ui/radio-group";
...
import { Slider } from "@/components/focuswin/common/ui/slider";
import { Switch } from "@/components/focuswin/common/ui/switch";
...
import { ButtonGroup, ButtonGroupText } from "@/components/focuswin/common/ui/button-group";
import { cn } from "@/lib/utils";
import Chip from "@/components/focuswin/common/ui/chip";

export default function DevsShow() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <main className="container max-w-6xl mx-auto pt-6">
        <div className="space-y-2 justify-between flex">
          <h2 className="text-3xl font-bold tracking-tight mb-6">Focuswin UI 라이브러리 (Shadcn/ui 기반)</h2>
              ...
              <CardContent className="pt-6 space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Chip label="Default" tone="slate" />
                    <Chip label="Secondary" tone="sky" />
                    <Chip label="Destructive" tone="red" />
                    <Chip label="Outline" tone="blue" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    <Avatar src="https://github.com/shadcn.png" fallback="CN" size={40} />
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Skeleton className="h-4 w-3/4 rounded-lg bg-slate-100" />
                ...
                <div className="space-y-2">
                  ...
                  <div className="rounded-2xl border border-border bg-white p-3">
                    ...
                    <p className="mt-2 text-xs text-muted-foreground text-center">Current page: {currentPage}</p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="overflow-hidden rounded-2xl border border-border bg-white">
                    <Table>
                      <TableCaption className="text-xs">A list of your recent invoices.</TableCaption>

                      <TableHeader className="bg-slate-50">
                        <TableRow>
                          <TableHead className="w-[120px] text-slate-500">Invoice</TableHead>
                      ...
                      <TableBody>
                        <TableRow className="hover:bg-slate-50/60">
                          ...
                          <TableCell>
                            <Chip size="xs" tone="emerald" label="Paid" />
                          </TableCell>
                          <TableCell className="text-muted-foreground">Credit Card</TableCell>
                          <TableCell className="text-right font-semibold">$250.00</TableCell>
                        </TableRow>

                        <TableRow className="hover:bg-slate-50/60">
                          <TableCell className="font-semibold">INV002</TableCell>
                          <TableCell>
                            <Chip size="xs" tone="amber" label="Pending" />
                          </TableCell>
                          <TableCell className="text-muted-foreground">PayPal</TableCell>
                          <TableCell className="text-right font-semibold">$150.00</TableCell>
                        </TableRow>

                        <TableRow className="hover:bg-slate-50/60">
                          <TableCell className="font-semibold">INV003</TableCell>
                          <TableCell>
                            <Chip size="xs" tone="red" label="Unpaid" />
                          </TableCell>
                ...
                <div className="space-y-2">
                  ...
                  <div className="rounded-2xl border border-border bg-white p-2">
                    <Menubar className="border-0 bg-transparent">
                      <MenubarMenu>
                        <MenubarTrigger className="rounded-xl px-3 py-2 text-sm font-semibold data-[state=open]:bg-slate-100">File</MenubarTrigger>
                        <MenubarContent className="rounded-2xl border-border shadow-[0_18px_50px_rgba(15,23,42,0.14)]">
                      ...
                      <MenubarMenu>
                        <MenubarTrigger className="rounded-xl px-3 py-2 text-sm font-semibold data-[state=open]:bg-slate-100">Edit</MenubarTrigger>
                        <MenubarContent className="rounded-2xl border-border shadow-[0_18px_50px_rgba(15,23,42,0.14)]">
                      ...
                      <MenubarMenu>
                        <MenubarTrigger className="rounded-xl px-3 py-2 text-sm font-semibold data-[state=open]:bg-slate-100">View</MenubarTrigger>
                        <MenubarContent className="rounded-2xl border-border shadow-[0_18px_50px_rgba(15,23,42,0.14)]">
                  ...
                  <div className="rounded-2xl border border-border bg-white px-4 py-3">
                    <Breadcrumb>
                      <BreadcrumbList className="text-sm">
                        <BreadcrumbItem>
                          <BreadcrumbLink className="text-slate-600 hover:text-slate-900" href="/">
                            Home
                          </BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator className="text-slate-400" />
                        <BreadcrumbItem>
                          <BreadcrumbLink className="text-slate-600 hover:text-slate-900" href="/components">
                            Components
                          </BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator className="text-slate-400" />
                        <BreadcrumbItem>
                          <BreadcrumbPage className="text-slate-900 font-semibold">Breadcrumb</BreadcrumbPage>
                        </BreadcrumbItem>
                      </BreadcrumbList>
                    </Breadcrumb>
                  </div>
